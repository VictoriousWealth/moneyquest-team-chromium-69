-- Create dummy quests for all curriculum sections
...
INSERT INTO quests (id, title, description, zone, npc, reward_coins, reward_xp, concepts, curriculum_section_id, order_in_sequence) VALUES
