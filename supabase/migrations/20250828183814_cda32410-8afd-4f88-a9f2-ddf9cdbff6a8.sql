-- Clean up duplicate achievements for Alex Johnson using valid achievement definition IDs
DO $$
DECLARE
    alex_user_id UUID;
BEGIN
    ...
    IF alex_user_id IS NOT NULL THEN
        ...
        (alex_user_id, 'smart_shopper', 'skill', 'Smart Shopper', 'Make smart purchasing decisions.', 30, '{"awarded_by": "system", "timestamp": "2025-08-20T09:15:00Z"}');
    END IF;
END $$;